...
public class MealTestData {
    ...
    public static void assertMatchById(Iterable<MealTo> actual, Iterable<Meal> expected) {
        assertThat(actual).usingComparatorForElementFieldsWithNames(Integer::compareTo, "id");
    }
}
